...
public final class index3_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction actualizarBreadcrumb(root_categories){\r\n");
      out.write("\t\t\t\t$(\"#breadcrumb\").html(\"\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif($('#breadcrumb').html() == \"\"){\r\n");
      out.write("\t\t\t\t\t$(\"<li><a href='javascript:actualizarCategoriasPrincipales()'> Categorias Principales </li>\").appendTo(\"#breadcrumb\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t            $.each(root_categories, function(i, category) {\r\n");
      ...
      out.write("\t\t\t\t\tactualizarBreadcrumb(response[2].path_from_root);\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t        \t\t\t\t\"<td>\" + traducir(item.condition) + \"</td>\" + \r\n");
      out.write("\t        \t\t\t\t\"<td>\" + traducir(item.buying_mode) + \"</td>\" + \r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction traducir(code){\r\n");
      out.write("\t\t\t\tswitch (code) {\r\n");
      out.write("\t\t\t\tcase \"new\":\r\n");
      out.write("\t\t\t\t\treturn \"Nuevo\";\r\n");
      out.write("\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\tcase \"buy_it_now\":\r\n");
      out.write("\t\t\t\t\treturn \"Compra Inmediata\";\r\n");
      out.write("\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\tdefault:\r\n");
