...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js"></script>
	...
	<script type="text/javascript">    
		...
		function armarPaginador(pagAnt, pagDesp){
			...
			if (pagAnt == null) pagAnt=3;
			if (pagDesp == null) pagDesp=3;
			
			var paginaLimiteInf = Math.max(1,(paginaActual - pagAnt));
			var paginaLimiteSup = Math.max(cantPaginas,(paginaActual + pagDesp));

			
			var paginadorHTML = "<h2>Paginación</h2><ul class='pagination'>";
			if (paginaActual > 1) paginadorHTML += "<li><a type='prev' href='#'>&lt; Anterior</a></li>";
			for(pagina = paginaLimiteInf ; pagina <= paginaLimiteSup ; pagina++){
				var selected = "";
				if (pagina = paginaActual) selected = "class='current'";
				paginadorHTML += "<li " + selected + "><a href='#'>" + pagina + "</a></li>";
			}
			if (paginaActual < cantPaginas) paginadorHTML += "<li><a type='next' href='#'>Siguiente &gt;</a></li>";
			paginadorHTML += "</ul>";
